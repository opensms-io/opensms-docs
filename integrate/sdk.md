...
opensms has official client libraries for nine languages, all generated by hand from one shared
...
|---|---|---|
| TypeScript / JavaScript | `@opensms/sdk` | npm |
| Python | `opensms` | PyPI |
| Go | `github.com/opensms-io/opensms-go` | git tag |
| .NET (C#) | `Opensms` | NuGet |
| Java | `io.opensms:opensms-java` | Maven Central |
| Rust | `opensms` | crates.io |
| Ruby | `opensms` | RubyGems |
| PHP | `opensms/opensms-php` | Packagist |
| Swift | `OpensmsSDK` | SwiftPM |
...
a real sandbox. All nine pass both suites against a local stack built as described in
[local development](../operations/local-development.md).

## The internal generated client

The API repository also contains `api/sdk/typescript` (`@opensms/api-client`, private, unpublished):
types generated from the OpenAPI contracts for the console and internal tooling. It covers session
and admin endpoints too, but it is not a supported public SDK; use `@opensms/sdk` instead.
